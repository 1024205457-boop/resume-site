...
(function () {
  ...
  const projects = {
    ...
    birdcircle: {
      ...
      summary: '围绕观鸟记录、物种内容和同好交流，构建小众兴趣社区的持续参与机制。',
      role: '设计观察记录、内容沉淀、社区互动和兴趣人群体验路径。',
      intro: '项目面向观鸟这一小众但高黏性的兴趣场景，解决用户记录分散、同好交流弱和持续参与不足的问题。由于本地资料中暂未看到完整 PRD 或 Demo 文件，当前网站只保留克制表达：重点呈现兴趣社区、记录工具和社群连接，不夸大 AI 能力。',
