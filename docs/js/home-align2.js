...
(function () {
  ...
  const projects = {
    ...
    frame: {
      ...
      action: [
        '场景定义：把产品从普通聊天陪伴收敛到“AI 情绪健康练习”流程',
        '引导设计：设计事件探索、感受细化、情绪认知三层递进式 Prompt',
        '多模态设计：结合视频、音频转写、语音情绪和文字内容形成分析输入',
        '工程实现：使用 FastAPI、Expo、LangChain、DashScope 和 YOLO 模型串联核心链路'
      ],
      evidence: [
        '项目路演时获得 2 家孵化器支持',
        '200+ 观众中 69 人愿意试用',
